        ...
        >
            ...
            <div className="relative" ref={userMenuRef}>
                <button
                    ...
                    className="mt-4 p-2 hover:bg-gray-200 rounded-lg w-full flex justify-center"
                ...
                {showUserMenu && (
                    ...
                    >
                        <div className="space-y-1">
                            <button className="w-full flex items-center gap-3 p-2 hover:bg-gray-100 rounded-lg text-left">
                                <Settings size={18} />
                            ...
                            <button className="w-full flex items-center gap-3 p-2 hover:bg-red-50 text-red-600 rounded-lg text-left">
                                <LogOut size={18} />

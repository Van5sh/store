...
//                     <NavigationMenuList className="flex flex-wrap gap-3 py-4">
//                         {items.map((item, id) => (
//                             <NavigationMenuItem key={id} className="list-none">
//                                 {item.subItems && item.subItems.length > 0 ? (
//                                     <>
//                                         <NavigationMenuTrigger
//                                             className={clsx(
//                                                 "px-6 py-3 font-semibold rounded-xl transition-all duration-300 backdrop-blur-sm border-2 bg-transparent",
//                                                 isActive(item.link)
//                                                     ? "bg-white! text-green-700! shadow-lg border-white scale-105"
//                                                     : "text-white border-white/20 hover:bg-white! hover:text-green-700! hover:shadow-xl hover:scale-105 hover:border-white data-[state=open]:bg-white! data-[state=open]:text-green-700!"
//                                             )}
//                                         >
//                                             {item.label}
//                                         </NavigationMenuTrigger>

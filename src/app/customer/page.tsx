        ...
        <div className="min-h-screen p-4 sm:p-6 lg:p-8" style={{ backgroundColor: colors.background.app }}>
            <div className="max-w-7xl mx-auto">
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
                    <div
                        className="lg:col-span-8 rounded-2xl border p-6 sm:p-8 shadow-sm"
                        style={{
                    ...
                    >
                        ...
                        <p className="text-base sm:text-lg max-w-2xl" style={{ color: colors.text.secondary }}>
                            This is the customer page where you can find various services tailored for you.
                        </p>
                    </div>

                    <div className="lg:col-span-4 rounded-2xl border p-6 shadow-sm" style={{ backgroundColor: colors.background.card, borderColor: colors.border.light }}>
                        <h2 className="text-xl font-semibold mb-4" style={{ color: colors.text.primary }}>Account Overview</h2>
                        <div className="grid grid-cols-2 gap-3">
                            <div className="p-4 rounded-xl" style={{ backgroundColor: colors.background.muted }}>
                                <p className="text-sm" style={{ color: colors.text.secondary }}>Total Orders</p>
                                <p className="text-2xl font-bold" style={{ color: colors.amber[600] }}>{orders.length}</p>
                            </div>
                            <div className="p-4 rounded-xl" style={{ backgroundColor: colors.background.accent }}>
                                <p className="text-sm" style={{ color: colors.text.secondary }}>Rewards Points</p>
                                <p className="text-2xl font-bold" style={{ color: colors.amber[500] }}>1,250</p>
                            </div>
                        </div>
                    </div>

                    <div className="lg:col-span-8 rounded-2xl border p-6 shadow-sm" style={{ backgroundColor: colors.background.card, borderColor: colors.border.light }}>
                    ...
                    <div className="lg:col-span-4 rounded-2xl border p-6 shadow-sm" style={{ backgroundColor: colors.background.card, borderColor: colors.border.light }}>
                        ...
                        <button
                            ...
                            onMouseEnter={(e) => e.currentTarget.style.backgroundColor = colors.amber[100]}
                            onMouseLeave={(e) => e.currentTarget.style.backgroundColor = ''}
                    ...
                    <div className="lg:col-span-6 rounded-2xl border p-6 shadow-sm" style={{ backgroundColor: colors.background.card, borderColor: colors.border.light }}>
                        <h2 className="text-2xl font-semibold mb-4" style={{ color: colors.text.primary }}>Quick Actions</h2>
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                            <button className="p-4 rounded-xl transition-colors" style={{ border: `1px solid ${colors.border.light}` }}
                              onMouseEnter={(e) => {
                    ...
                    <div className="lg:col-span-6 rounded-2xl border p-6 shadow-sm" style={{ backgroundColor: colors.background.card, borderColor: colors.border.light }}>
                        ...
                        <div className="space-y-3">
                            <div className="p-4 rounded-xl cursor-pointer transition-colors" style={{ border: `1px solid ${colors.border.light}` }}
                              onMouseEnter={(e) => {
                                e.currentTarget.style.borderColor = colors.border.accent;
                                e.currentTarget.style.backgroundColor = colors.background.muted;
                              }}
